...
public class GSMessage {
    ...
    public static var successBackgroundColor: UIColor = UIColor.emeraldColor()
    public static var warningBackgroundColor: UIColor = UIColor.cloudsColor()
    public static var errorBackgroundColor: UIColor = UIColor.pomergranateColor()
    public static var infoBackgroundColor: UIColor = UIColor.peterRiverColor()
